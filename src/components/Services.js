...
const Services = () => {
  ...
  >
    ...
    <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
        <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
            ...
            <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center lg:mr-24"> 
                ...
                <h3 className="text-3xl text-green-900 font-bold">We <span className='font-black'>Build</span></h3>
                <div>
    ...
    <h3 className="text-3xl text-green-900 font-bold">We <span className='font-black'>Provide Solutions</span></h3>
    <div>
        <p className='my-3 text-xl text-gray-600 font-semibold'>
        Leveraging years of experience in SAP technologies, we specialize in crafting tailored solutions that harness the power of SAP's suite of enterprise software. From intricate implementations to seamless integrations, we optimize your business processes and drive growth with SAP at the core.
        </p>
    </div>
</div>
