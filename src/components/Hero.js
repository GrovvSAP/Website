      ...
      <div className="m-auto content-container overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">
        <div className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
          ...
          <h1 className={`mb-5 md:text-5xl text-3xl font-bold text-custom-color2 ${isRTL ? 'text-left' : 'lg:text-right'}`}>
            ...
            <Link to="/contact" className={`text-white bg-custom-bg-color2 hover:bg-green-800 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0 ${isRTL ? 'text-left' : 'lg:text-right'}`}>
