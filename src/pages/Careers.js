...
const Contact = () => {
  ...
  if (isLoading) {
    ...
    <div className="container mx-auto text-center">
        <h2 className="text-3xl font-semibold mb-4">{t("Careers.header1")}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 shadow-md hover:bg-green-200 transition duration-300 rounded-full flex flex-col items-center justify-center">
                ...
                <h3 className="text-lg font-semibold mb-2">{t("Careers.Bubble1Header")}</h3>
            ...
            <div className="bg-white p-6 shadow-md hover:bg-green-200 transition duration-300 rounded-full flex flex-col items-center justify-center">
                ...
                <h3 className="text-lg font-semibold mb-2">{t("Careers.Bubble2Header")}</h3>
            ...
            <div className="bg-white p-6 shadow-md hover:bg-green-200 transition duration-300 rounded-full flex flex-col items-center justify-center">
                ...
                <h3 className="text-lg font-semibold mb-2">{t("Careers.Bubble3Header")}</h3>
            ...
            <div className="bg-white p-6 shadow-md hover:bg-green-200 transition duration-300 rounded-full flex flex-col items-center justify-center">
                ...
                <h3 className="text-lg font-semibold mb-2">{t("Careers.Bubble4Header")}</h3>
...
<div id="why-section" className="bg-gray-100 py-20 mt-">
    <div className="container mx-auto text-center">
        <h2 className="text-3xl font-semibold mb-8">{t("Careers.CardsTtile")}</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 shadow-md hover:bg-green-200 transition duration-300 rounded-lg flex flex-col items-center justify-center relative">
                <div className="flex items-center justify-end mb-2">
                    <span className="bg-green-500 text-white px-2 py-1 rounded-full uppercase text-sm absolute right-2 top-2">{t("Careers.LeftCardLevel")}</span>
                </div>
                
                <i className="fas fa-code text-3xl text-green-500 mb-3"></i>
                <h3 className="text-lg font-semibold mb-2 text-xl">{t("Careers.LeftCardHeader")}</h3>
