...
const Services = () => {
	...
	<section data-aos="zoom-in-down">
		<div className="my-4 py-4">
			<h2 className="my-2 text-center text-3xl text-custom-color2 uppercase font-bold"> {t("Services.PageHeader.header")}</h2>
			<div className='flex justify-center'>
				<div className='w-24 border-b-4 border-85CD40'/>
			</div>
