    ...
    return (
        ...
        <section data-aos="zoom-in-down">
                ...
                <div className="my-4 py-4">
                    <h2 className="my-2 text-center text-3xl text-85CD40 uppercase font-bold"> {t("Services.PageHeader.header")}</h2>
                    
                    <div className='flex justify-center'>
                        <div className='w-24 border-b-4 border-85CD40'></div>
                    </div>
                    <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-85CD40">{t("Services.PageHeader.paragraph")}</h2>
                </div>
